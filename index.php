...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/bootstrap.min.css,agency.css">
...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="">Infy</a>
            </div>
        ...
        <div class="container">
            <div class="intro-text">
                ...
                <!-- <div id="socialMediaWidgets">
                  <div id="shareme" data-url="http://www.fantasticcleaners.com/" data-text="Make your sharing widget with Sharrre (jQuery Plugin)"></div>
                </div> -->
    ...
    <script type="text/javascript">
     ...
     element.src = "js/jquery.js,bootstrap.min.js,classie.js,cbpAnimatedHeader.js,jqBootstrapValidation.js,contact.me.js,socialite.js,agency.js";
